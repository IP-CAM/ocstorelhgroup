Journal.contactPrivacy = parseInt('<?php echo $this->journal2->settings->get('popup_privacy', '1') && $this->journal2->settings->get('popup_privacy_information') ? $this->journal2->settings->get('popup_privacy_information') : '0'; ?>', 10);
